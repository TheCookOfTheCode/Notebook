...
{
  if(Application->MessageBoxA("Czy na pewno utworzyc nowy plik?","PotwierdŸ",
...
{
  if(Application->MessageBoxA("Czy na pewno zakoñczyc program?","PotwierdŸ",
...
void __fastcall TForm1::Zapraszamnafb1Click(TObject *Sender)
{
